...
select * from DOCTOR;
insert into DOCTOR(HOSPITAL_COD, APELLIDO, ESPECIALIDAD) values ((select max(HOSPITAL_COD)+1), 'HOUSE', 'Diagnostico')
where NOMBRE=(selec
12.
...
13.
Mo
dificar el salario de los empleados trabajen en la paz y estén destinados a
Psiquiatría. Subirles el sueldo 20000 Ptas. más que al señor Amigo R.
14.
Insertar un empleado con valores null (por ejemplo la comisión o el oficio), y
después borrarlo
buscando com
o valor dicho valor null creado.
15.
Borrar los empleados cuyo nombre de departamento sea producción.
16.
Borrar todos los registros de la tabla Emp
sin delete
